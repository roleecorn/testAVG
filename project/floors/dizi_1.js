main.floors.dizi_1=
{
    ...
    "eachArrive": [
        ...
        "\t[梗平](哦？是憂國憂民的演說家？難道她發現了修卡企圖顛覆國家的陰謀了？)",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0,
        ...
        "\t[梗平](是腦改造！而且是大規模的洗腦計畫！修卡竟然已經把魔爪伸向了普通市民！這個女孩……她是倖存者，或是試圖掙脫控制的抵抗者！)",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0,
        ...
        "\t[梗平]妳不用害怕！我是假面騎士，是為了守護大家的自由與和平而戰的！妳剛剛說的「被決定好的話語」，就是他們洗腦的證據對吧！",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0,
        ...
        "\t[梗平]NPC？那是修卡給妳這種抵抗者取的代號嗎？放心，從今天起，妳的代號就是「騎士協力者一號」！",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0,
        ...
        "\t[梗平]「哼，看來還在警戒我嗎……不過，我已經記住妳了，地子同志！我們終將再次相遇！」",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0,
