main.floors.main_ch7_3=
{
    ...
    "eachArrive": [
        ...
        "\t[東山]（手機）為了防止IB再度獨自升級須要解決這事，有啥好想法嗎？",
        {
            "type": "hideImage",
            "code": 20,
            "time": 0
        ...
        "\t[蘭斯]（手機）ANIsister昨天進去過，內部的肥宅數量很可怕",
        {
            "type": "hideImage",
            "code": 20,
            "time": 0
        ...
        "\t[蘭斯]（手機）剛剛抓了一隻，但怪叫著跑走了無法溝通，可能得深入ANIsister看看了",
        {
            "type": "hideImage",
            "code": 20,
            "time": 0
        ...
        "\t[蘭斯]（手機）沒有…聽IB說後來梗平跟警察在裡面，不知道有沒有啥新發現？",
        {
            "type": "hideImage",
            "code": 20,
            "time": 0
