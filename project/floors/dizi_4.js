main.floors.dizi_4=
{
    ...
    "eachArrive": [
        ...
        "\t[梗平]地子同志！妳也來偵查敵情嗎？我已經將人流動線和所有可能的撤退路線都記在腦子裡了，隨時可以發動突襲！",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]什麼？！竟然想從創作的根源下手……這是對阿宅靈魂最惡毒的攻擊！不可原諒！",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]（衝到櫃檯前）給我站住！東方不敗！你那破壞Comike的邪惡陰謀已經被我識破了！",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]「寶物」……原來如此！是指能克制病毒的特殊道具嗎！我明白了！為了守護大家的熱情與夢想，我絕不會退縮！",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]「呼……好強的氣……不愧是修卡的首席武術家。我必須盡快找到能與之抗衡的『寶物』才行！」",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]這不是隨機事件！這是真實的戰鬥！不過，多虧了妳，我才能守護大家的夢想！",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]「地子同志……妳是像風一樣的戰士，一個在暗中支援各個戰區的秘密特工！妳在秋葉原的任務已經完成，接下來就要前往下一個被修卡威脅的城市，對吧！」",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]「『邂逅不同的人，好好努力喔』……妳是把守護秋葉原、守護Comike的重責大任，正式託付給我了啊！」",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]「那不是悲傷的笑容……那是將意志託付給後繼者後，如釋重負的、戰士的笑容！長期與修卡戰鬥，肯定讓妳身心俱疲了……」",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]我收到了，地子同志！妳的意志，妳的戰鬥，就由我假面騎士梗平來繼承！",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]「首先，要找到足以撼動『東方不敗』靈魂的『寶物』，然後要集結新的夥伴……」",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]「等著我，修卡！等著我，Comike！假面騎士的戰鬥，現在才正要開始！」",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
