main.floors.main_ch7_4=
{
    ...
    "eachArrive": [
        ...
        "\t[東山]店的經營沒問題嗎？竟然還支薪？",
        "\t[克莉絲]『瑪利亞之牆』的招牌改成『希娜之牆』算了…",
        "\t[蘭斯]有沒有一個可能，直至今日店裡才真正的有了『女』僕",
        "\t[表妹]不是有嗎？叫漆原的可愛妹子",
        "\t[桶至學長]但是，是男的",
        "\t[表妹]你們都市人真會玩",
        "\t[東山]喔想起來有個似乎能解決ANIsister問題的方法",
        "\t[東山]晚上11點在『雜貨店後面』集合",
        "\t[東山]對方叫我多找點人",
        "\t[眾人]一定到",
        {
        ...
        "\t[東山]所以是在什麼情境下發生的啊？",
        "\t[貝琪]我們兩人在車上休息時他主動把手搭了過來！",
        "\t[貝琪]用著他深邃的小眼神對著我說『我們在一起好嗎？』",
        "\t[貝琪]雖然他說還需要點時間，真是個害羞的小傢伙～",
        "\t[東山]那麼為了將來，貝琪親該開始準備了呢！",
        "\t[貝琪]這麼說來應該要通知一下親友…",
        "\t[東山]是呢！這麼值得慶祝的事情就應該『昭告天下』讓大家共同分享這份喜悅",
        "\t[貝琪]好主意呢！東山醬有妳在真是太好了～愛妳喔～",
        {
            "type": "showImage",
            "code": 20,
            "image": "dongshan_normal.png",
