main.floors.watanuki_sakuya_2=
{
    ...
    "eachArrive": [
        ...
        "\t[梗平]不，只是因為匆忙製作的騎士系統導致我身體菠蘿菠蘿噠…被恐懼心驅使前往這裡",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]忘了吧，那個不重要的。簡單來說就是我為了向神明祈求得到強化形態而來。",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
        ...
        "\t[梗平]啊，其實是我打算抽假面騎士新的一番賞所以來這裡求保佑啦！",
        {
            "type": "hideImage",
            "code": 10,
            "time": 0
            ...
            "choices": [
                ...
                },
                {
                    ...
                    "action": [
                        ...
                        "\t[梗平]果然依賴神力護體萬萬不可！巫女小姐，我決定用人類姿態挑戰！",
                        {
                            "type": "hideImage",
                            "code": 10,
                            "time": 0
