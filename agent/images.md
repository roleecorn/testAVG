...
[
    ...
    {"type": "hideImage", "code": 10, "time": 0, "async": true},
    {"type": "hideImage", "code": 11, "time": 0, "async": true},
    {"type": "showImage", "code": 11, "image": "mei.png", "loc": [239, 165], "opacity": 1, "time": 0},
    "\t[表妹]這一句只顯示表妹。",
...
"images": [
    ...
    {"name": "mei_portrait.png", "canvas": "fg", "x": 239, "y": 165, "disabled": true}
],

"firstArrive": [
    {"type": "hideFloorImg", "loc": [[28, 210], [239, 165]]},
    "\t[旁白]這句旁白不顯示人物。",
...
- 表妹 `mei_portrait.png`：`x: 239, y: 165`
...
[
    {"type": "hideImage", "code": 10, "time": 0, "async": true},
    {"type": "hideImage", "code": 11, "time": 0, "async": true},
    {"type": "hideImage", "code": 12, "time": 0, "async": true},
...
| 表妹 | 11 | `[239, 165]` | 預設 | `mei_portrait.png` |
| 蘇芳 | 12 | `[260, 185]` | 哀、難過 | `suou_sad_portrait.png` |
| 蘇芳 | 12 | `[260, 185]` | 怒、生氣 | `suou_angry_portrait.png` |
| 蘇芳 | 12 | `[260, 185]` | 喜、微笑 | `suou_smile_portrait.png` |
| 蘇芳 | 12 | `[260, 185]` | 樂、開心 | `suou_happy_portrait.png` |
| 蘇芳 | 12 | `[260, 185]` | 顏藝、崩壞 | `suou_goofy_portrait.png` |
| 蘇芳 | 12 | `[260, 185]` | 驚訝、錯愕 | `suou_surprised_portrait.png` |
